...
If for some reason your file looks different, you can copy the above and run the
...
Similar to the compile-styles script, the css-minify script is also quite long
