...
At this point all the function does is set the
...
Next add some basic validation to ensure that the comment form is submitted
appropriately.
...
Since this code resides within a serverless function there is no state that is
